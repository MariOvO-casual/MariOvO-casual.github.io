...
function onRotationInput() {
    ...
    x = document.getElementById("rotSlider").value;
    y = document.getElementById("rotSliderY").value;
    z = document.getElementById("rotSliderZ").value;
    selectedCube.setRotate(x, y, z);
}
...
function TanslateIn(){
  ...
  z = document.getElementById("TransZ").value;
  selectedCube.setTranslate(x/100, y/100, z/100);
}

function ScaleIn(){
  let selector = document.getElementById("cubeSelect");
  let selectedCube = cubes[selector.value];
  x = document.getElementById("ScaleX").value;
  y = document.getElementById("ScaleY").value;
  z = document.getElementById("ScaleZ").value;
  selectedCube.setScale(x/100, y/100, z/100);
}
...
function main() {
    ...
    cube1.setTranslate(0.0, 0, -0.5);
    cube1.setScale(0.15, 0.15, 0.75);
    cube1.setRotate(80,0,150);

    let cube2 = addCube([0.0, 0.0, 1.0]);
    cube2.setTranslate(0.3, 0.1, -0.5);
    cube2.setScale(0.2, 0.2, 0.6);
    cube2.setRotate(0,-90,0);
